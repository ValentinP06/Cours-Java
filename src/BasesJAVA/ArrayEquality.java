...
public class ArrayEquality {
    public static void main(String[] args) {
        ...
        nombres[1]=15;
        nombres[2]=20;
        System.out.println("BasesJAVA.Affichage tableau nombre1 :"+ Arrays.toString(nombres));

        int[] nombres2=nombres;
        nombres2[0]=33;

        System.out.println("BasesJAVA.Affichage tableau nombre1 après création de nombre 2 :"+ Arrays.toString(nombres));
        ...
        System.out.println("BasesJAVA.Affichage nombre 3 : "+Arrays.toString(nombres3));
